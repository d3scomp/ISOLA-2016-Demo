    ...
    for mode in ['standard']:#['standard', 'quantum']:
        for fitness in ["PreferDistant"]:#["PreferClose", "PreferDistant", "PreferNeutral"]:
            for radiorange in [5]:#[3, 5, 7]:
                ...
                'headline': "(a) Prefer distant beacons - rebroadcast radius influence",
                #'headline': "(a)",
                ...
                'headline': "(b) Prefer distant beacons - rebroadcast period influence",
                #'headline': "(b)",
...
#        ax2.plot(px, y, 'go', alpha=0.4)
    ...
    fig.text(x=0.5, y=1, s=name, verticalalignment="top", horizontalalignment="center")
