...
public class AntWorldPlugin implements DEECoPlugin, TimerTaskListener {
	...
	public static final double DEFAULT_SOURCE_APPEAR_PROBABILITY_PER_S = 1.0 / 15.0;
	public static final double DEFAULT_SOURCE_DISAPPEAR_PROBABILITY_PER_S = 1.0 / 60.0;
